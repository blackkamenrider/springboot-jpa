...
import com.hosias.evolucao.services.ProductService;

@RestController // pra que esta classe seja um recurso web e que e implementado por um controlador rest
@RequestMapping(value = "/products") //caminho do recurso coloquei users porq a classe criada foi userResource
