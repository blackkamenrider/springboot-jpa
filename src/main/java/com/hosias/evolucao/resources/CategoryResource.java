...
import com.hosias.evolucao.services.CategoryService;

@RestController // pra que esta classe seja um recurso web e que e implementado por um controlador rest
@RequestMapping(value = "/categories") //caminho do recurso coloquei users porq a classe criada foi userResource
